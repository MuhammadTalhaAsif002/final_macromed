...
import logo from "public/images/macromed-logo.png";
import eye from 'public/images/e-commerce/login/eye.png';
import eyeOff from 'public/images/e-commerce/login/eye-off.png';
import Head from 'next/head';
// import google from "public/images/e-commerce/login/google.svg";
// import facebook from "public/images/e-commerce/login/facebook.svg";
...
class Index extends React.Component {
  ...
  constructor(props) {
    ...
    this.changePracticeType = this.changePracticeType.bind(this);
  }
  ...
  changePracticeType(event) {
    this.setState({ practice_type: event.target.value });
  }
              ...
              <Row className={"d-flex justify-content-center"}>
                <Col lg={8} xs={"auto"}>
                  ...
                  <Form className={"w-100"} onSubmit={this.doRegister}>
                    ...
                    <FormGroup>
                      <Label for="practiceType" className="fw-bold">Practice Type</Label>
                      <Input
                        type="select"
                        name="practiceType"
                        id="practiceType"
                        className={`w-100 ${s.practiceTypeSelect}`}
                        value={this.state.practice_type}
                        onChange={this.changePracticeType}
                        required
                      >
                        <option value="clinics">Clinics</option>
                        <option value="general hospitals">General Hospitals</option>
                        <option value="specialized hospitals">Specialized Hospitals</option>
                        <option value="surgeons">Surgeons</option>
                        <option value="procurement officers">Procurement Officers</option>
                      </Input>
                    </FormGroup>
                    <div
                      className={

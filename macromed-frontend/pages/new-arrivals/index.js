...
const NewArrivals = () => {
  ...
  return (
    <>
      <Head>
        <title>New Arrivals - Macromed</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta name="description" content="Discover our latest new arrivals in surgical equipment and medical tools" />
        <meta name="keywords" content="new arrivals, surgical equipment, medical tools" />
      ...
      <Container style={{ marginTop: 80, marginBottom: 80 }}>
        ...
        <h1 className="text-center fw-bold mb-4">New Arrivals</h1>

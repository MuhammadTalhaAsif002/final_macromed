...
const TrendingProducts = () => {
  ...
  return (
    <>
      <Head>
        <title>Trending Products - Macromed</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta name="description" content="Discover our trending surgical equipment and medical tools" />
        <meta name="keywords" content="trending products, surgical equipment, medical tools" />
      ...
      <Container style={{ marginTop: 80, marginBottom: 80 }}>
        ...
        <h1 className="text-center fw-bold mb-4">Trending Products</h1>
